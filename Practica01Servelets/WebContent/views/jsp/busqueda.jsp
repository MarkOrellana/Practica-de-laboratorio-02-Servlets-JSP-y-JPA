...
<script src="https://kit.fontawesome.com/e564244708.js"
...
<body>
	...
	<div class="ui container" style="color:hsla(0,100%,50%,1);">
		<div class="ui secondary  menu">
			<div class="item logo">
				<a href="/Practica01Servelets"><h2>
						<span>Crazy</span>Killer
					</h2></a>
			</div>
											...
											<div class="content">
												...
												<div class="meta">
													<i class="envelope icon"></i> <a
														href="mailto:${user.correo}"> ${user.correo}</a>
												</div>
